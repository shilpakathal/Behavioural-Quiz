...
import com.shilpa.personalitytestapp.ui.QuestionsList.QuestionsListActivity;
...
public class SelectCategoryAdapter extends RecyclerView.Adapter<SelectCategoryAdapter.CategoryName> {
    ...
    public SelectCategoryAdapter(Context context, List<String> categoryList, List<String> questionList) {
